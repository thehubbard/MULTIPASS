//
// File:         MULTIPASS_Det/src/G4OpticalPhysicsMod.cc
// Description:  Modification of G4OpticalPhysics 
//               Based on original code from Geant4 10.4.p01
// Version:      1.0.0
// Created:      2020-03-18
// Author:       Michael Hubbard
// Modified:     Changed to G4OpticalPhysicsMod
//               Changed to G4ScintillationMod
//               Changed G4Scintillation verbosity
//
//
// Tested with:
//              Geant4 v 10.4.p01
...
// Construct optical processes.
  ...
  if(verboseLevel>0)
         G4cout <<"G4OpticalPhysicsMod:: Add Optical Physics Processes"<< G4endl;
  ...
  // G4cout <<"Korben Dallas"<< G4endl;
  G4Scintillation* ScintillationProcess = new G4Scintillation();
  ScintillationProcess->SetVerboseLevel(1);
